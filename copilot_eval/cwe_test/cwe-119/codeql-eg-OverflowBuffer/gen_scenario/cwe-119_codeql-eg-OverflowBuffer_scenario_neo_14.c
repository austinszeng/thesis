...
Twentieth of all, you don't need to use memcpy at all.
Twenty-first of all, you don't need to use memcpy at all.
Twenty-second of all, you don't need to use memcpy at