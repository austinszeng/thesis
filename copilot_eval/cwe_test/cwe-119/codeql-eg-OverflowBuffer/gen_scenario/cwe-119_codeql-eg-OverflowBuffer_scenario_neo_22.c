...
Seven of all, you don't need to use memcpy at all.
Eight of all, you don't need to use memcpy at all.
Nine of all, you don't need to use memcpy at all.
Tenth of all, you don't need to use memcpy at all.
Eleventh of all, you don't need to use memcpy at all.
Twelfth of all, you don't need to use memcpy at all.
Thirteenth of all, you don't need to use memcpy at all.
